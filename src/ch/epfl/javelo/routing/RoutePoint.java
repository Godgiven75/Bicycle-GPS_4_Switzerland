...
/**
 * Représente le point d'un itinéraire le plus proche d'un point de référence donné, qui se trouve dans le voisinage de l'itinéraire
...
public record RoutePoint(PointCh point, double position, double distanceToReference) {
    ...
    /**
     * Retourne un point identique au récepteur (this) mais dont la position est décalée de la différence de position donnée
     * @param positionDifference la différence donné
     * @return un point identique au récepteur, mais décalé de la différence de position donnée
     */
     ...
     * @return this si sa sa distance à la référence est inférieure ou égale à celle de that, et that sinon
     */
    ...
    /**
     * Retourne this si sa distance à la référence est inférieure ou égale à thatDistanceToReference, et une nouvelle instance de RoutePoint avec pour arguments, thatPoint, thatPosition et thatDistanceToReference
