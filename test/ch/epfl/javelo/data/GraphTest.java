...
public class GraphTest {
    ...
    public void nodePointReturnsNodeIdPosition() throws IOException {
        ...
        System.out.println(WebMercator.x(6.6013034) + " " + WebMercator.y(46.6326106));
        assertEquals( (new PointWebMercator(WebMercator.x(6.6013034), WebMercator.y(46.6326106))).toPointCh()
                , g.nodePoint(2022));
